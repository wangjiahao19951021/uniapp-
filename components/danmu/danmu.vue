<template>
	<view style="position: fixed; bottom: 120rpx; left: 0; right: 0; width: 520rpx; height: 300rpx;">
		<scroll-view scroll-y="true" style="width: 520rpx; height: 300rpx;" scroll-with-animation :scroll-into-view="scrollInToview">
